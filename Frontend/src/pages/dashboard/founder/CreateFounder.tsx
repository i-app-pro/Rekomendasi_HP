...
export default function CreateFounder({ isOpen, onClose, onSave }: CreateFounderProps) {
  ...
  // Preview: file yang baru dipilih (object URL) diprioritaskan, kalau tidak ada
  // pakai nilai foto URL yang sedang diketik.
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      setIsSaving(true);
      setError(null);
      await onSave({ ...formData, fotoFile: fotoMode === 'file' ? fotoFile : null });
