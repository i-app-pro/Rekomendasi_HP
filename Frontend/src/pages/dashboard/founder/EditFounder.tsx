...
import { type FounderData } from './CreateFounder';

interface EditFounderProps {
  isOpen: boolean;
  onClose: () => void;
  onUpdate: (data: FounderData) => void;
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-6 flex flex-col gap-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" name="keahlian" value={formData.keahlian} onChange={handleChange} required className="w-full px-3 py-2 border border-slate-300 rounded-lg text-sm outline-none focus:ring-2 focus:ring-blue-500" />
            </div>
            <div>
